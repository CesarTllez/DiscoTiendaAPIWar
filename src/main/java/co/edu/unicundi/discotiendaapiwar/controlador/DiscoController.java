...
public class DiscoController {
    ...
    @POST
    @Path("/registrar")
    public Response registrar(@Valid Disco disco)throws ResourceNotFoundException, EntityValidationException, EntityValidationException, ResourceConflictException, UnauthorizedException {
    ...
    @POST
    @Path("/comprar")
    public Response comprar(CompraDto idDisco, @HeaderParam("Authorization") String token)throws ResourceNotFoundException, EntityValidationException,ResourceConflictException, UnauthorizedException{
